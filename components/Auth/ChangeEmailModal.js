...
export const ChangeEmailModal = ({
  ...
  <Transition appear show={changeEmailModalIsOpen} as={Fragment}>
    <Dialog
      ...
      onClose={changeEmailModalHandler}
    >
          ...
          <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-lightBackgroundColor shadow-xl rounded-2xl">
            ...
            <div className="mt-4 sm:flex items-center sm:justify-end sm:space-x-2 space-y-2 sm:space-y-0">
              <div>
                <button
                  type="button"
                  className="inline-flex w-full justify-center px-4 py-2 text-sm font-medium text-white bg-disabledGrey border border-transparent rounded-md hover:bg-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
                  onClick={changeEmailModalHandler}
                >
                  Cancel
                </button>
              </div>
