export default function CardOption(props) {
  return (
    <div className="border border-dashed border-white h-32 rounded-xl flex flex-col space-y-3 items-center justify-center text-gray-200 cursor-pointer w-full px-8">
      ...
      <button
        onClick={() => props.addingHandler(false)}
